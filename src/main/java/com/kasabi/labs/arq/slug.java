...
import com.kasabi.labs.datasets.italy.GeonamesItaly;

public class slug extends FunctionBase {
    ...
    private static NodeValue normalise(NodeValue nvString)
    {
        try {
            String string = nvString.getString() ;
            return NodeValue.makeString(com.kasabi.labs.datasets.Utils.toSlug(GeonamesItaly.normalise(string))) ;
