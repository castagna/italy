...
public class normalise extends FunctionBase {
    ...
    public NodeValue exec(List<NodeValue> args) {
        ...
        return _normalise(v1) ;
    }
    
    private static NodeValue _normalise(NodeValue nvString)
    {
        try {
            String string = nvString.getString() ;
            return NodeValue.makeString(GeonamesItaly.normalise(string)) ;
